...
<nav>
  <ul>
    <a href="friends.html"><li>Friends</li></a>
    <a href="myposts.html"><li>My Posts</li></a>
    <a href="myclaims.html"><li>My Claims</li></a>
...
<body>
	<div class="container">
		...
		<div class="jumbotron">
			<h1>Dibs!</h1>
			<a href="posting.html"><button id="postButton" class="btn btn-primary btn-lg">Put something up for dibs</button>
		</div>
